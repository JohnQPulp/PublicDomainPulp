...
internal static class Helpers {
	...
	public static byte[] BuildCatalogPage(Dictionary<string, VisualNovel> visualNovels) {
		...
		foreach (VisualNovel pulp in visualNovelList) {
			...
			html.Append("</p>");
			html.Append($"<p class='small center'>See the <a href='{pulp.Metadata.Repo}'>JohnQPulp/{pulp.DirName} Github repository</a> for offline downloading and issue tracking.</p>");
