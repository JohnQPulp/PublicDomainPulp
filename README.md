...
Also we do a little editorializing. (Not changing or simplifying the original writing, mind you — [that would be bad](https://www.goodreads.com/book/show/13079982-fahrenheit-451) — but just adding "helpful" editor's notes.)
...
An even easier setup than https://github.com/standardebooks/web.git, I'd say. Take *that*, [Alex Cabal](https://alexcabal.com/posts/standard-ebooks-and-classic-web-tech).
